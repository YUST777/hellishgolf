...
zoomed PNG so we can eyeball what the glyph is."""
import json
...
TS = Image.open(MAPS / "tileset.png").convert("RGBA")
T = 16
COLS = TS.width // T  # 33
...
# Dump the top floating frames as zoomed pngs.
...
for tid, _ in floating.most_common(12):
    ...
    frame.save(out / f"tile_{tid}.png")
