...
Outputs into public/game/hellish/gen/:
  lava_anim.png  - 7-frame 16x16 animated molten-lava strip (112x16)
  torch_anim.png - 7-frame 16x32 animated torch strip (112x32)
  rock_fill.png  - 16x16 rock ground fill
  rock_top.png   - 16x16 rock with lit lava top edge
...
for i, fr in enumerate(lava_frames):
    lava.paste(fr, (i * T, 0))
lava.save(OUT / "lava_anim.png")
print(f"lava_anim.png {lava.size}")
...
torch.save(OUT / "torch_anim.png")
print(f"torch_anim.png {torch.size} (frame {tw}x{th})")
...
(best_fill or tile(0, 7)).save(OUT / "rock_fill.png")
(best_top or best_fill or tile(0, 3)).save(OUT / "rock_top.png")
